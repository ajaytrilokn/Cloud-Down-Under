    ...
    <div class="container">
        <div class="row">
                ...
                <div class="sales-manager-details">
                    ...
                    <div class="sm-details-bottom">
                        ...
                        <div class="sm-details-img">
                            <img src="<?php bloginfo('template_url'); ?>/assets/images/manager-img.png" alt="#">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 contact_us_form" id="contact_us_form">
                ...
                <?php echo do_shortcode('[contact-form-7 id="16d11b7" title="Home Contact"]');?>
            </div>
        </div>
    </div>
</section>
