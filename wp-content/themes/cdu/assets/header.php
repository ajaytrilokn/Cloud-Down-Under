				          	...
				          	<div class="navbar-container">
					            <nav class="navbar navbar-dark navbar-expand-lg">
					               <!--  <div class="header-logo">
					              	...
					              	<div class="header-logo">
					                	<a href="https://new.clouddownunder.com.au/">
					                		<!-- <img class="header-logo-1" src="assets/images/appgurus-white.png" alt="header-logo">
					                		<img class="header-logo-2" src="assets/images/appgurus-black.png" alt="header-logo"> -->
												    ...
												    <ul class="navbar-nav">
														<li class="nav-item sm_menu_main ">
															<div class="main-menu" id="menu_servece1">
															  	 <a href="https://new.clouddownunder.com.au/service/">Services</a>
														...
														<li class="nav-item"><a href="https://new.clouddownunder.com.au/our-work/">Work</a> </li>
														<li class="nav-item"><a href="https://new.clouddownunder.com.au/about-us/">About Us</a></li>
														<li class="nav-item"><a href="https://new.clouddownunder.com.au/career/">Career </a></li>
														<li class="nav-item"><a href="https://new.clouddownunder.com.au/blog/">Insights</a></li>
